...
module cork_token::cork_token {
    ...
    public struct CorksMinted has copy, drop {
        recipient: address,
        amount: u64,
        reason: vector<u8>,
        timestamp: u64
    ...
    public struct CorksBurned has copy, drop {
        burner: address,
        amount: u64,
        reason: vector<u8>,
        timestamp: u64
    ...
    public struct CorksTransferred has copy, drop {
        from: address,
        to: address,
        amount: u64,
        timestamp: u64
